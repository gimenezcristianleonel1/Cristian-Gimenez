...
class AuthService:
    ...
    def crear_usuario(self, nombre: str, email: str, password: str, rol: RolUsuario) -> Usuario:
        ...
        return self.repository.create(
            nombre=nombre, email=email, hashed_password=hash_password(password), rol=rol
        )
    ...
    def autenticar(self, email: str, password: str) -> TokenResponse:
        ...
        token = create_access_token(subject=str(usuario.id), role=usuario.rol.value)
